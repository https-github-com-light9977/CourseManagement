...
<br>
        ...
        <div class="content">
            <label class="logout-button">作业列表>></label>
            <br><br><br>
                <table align="center" class="homework-table">
                    ...
                    <%
                        ArrayList homeworks=(ArrayList)request.getAttribute("homeworkArrayList");
                    %>
                    ...
                    <tr>
                        ...
                        <td><a class="logout-button" href="/CourseManagement_war_exploded/hwcontent?classid=<%=classinfo.get(0)%>&stuid=<%=userBean.getLogid()%>&hwid=<%=homework.getHwid()%>" >
                            查看详情</a></td>
                    </tr>
                    <% } %>
                </table>
