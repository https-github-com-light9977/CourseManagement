...
<%--                <a id="choice5-link" class="choiceheader"  onclick="showContent('choice5'); setActiveLink('choice5-link')" href="#" >分组</a>--%>
            ...
            <div class="content">
                <form action="submitreleaseHw" method="post" enctype="multipart/form-data">
                    ...
                    <input type="radio" id="student" name="group" value="y" onclick="showResultLink()" checked>
                    <label for="是">是</label>
                    <input type="radio" id="student" name="group" value="n" onclick="hideResultLink()" >
                    <label for="否">否</label><br><br>
                    <botton id="result-link" >
                        <a href="/CourseManagement_war_exploded/group?classid=<%=classid%>" id="group-result">查看分组</a>
                    </botton>
                    <br>
                    <br>
...
<%--                    <br><br>--%>
                    ...
                    <input type="hidden" name="backnews" value="<%=backnews%>">
                    <br>
