    ...
    <div class="right">
        ...
        <div class="choiceheader">
            ...
            <div id="choice1" class="choicecontent">
                <h1 style="font-size: 17px">签到列表>></h1>
                <table align="center" class="checkin-table">
                    ...
                    <tr><td><%=scheckIn.getCheckin_id() %></td>
                        <td><%=scheckIn.getCheckin_deadline() %></td>
                        <td><%=scheckIn.getChecked()%></td>
                        <td><a href="/CourseManagement_war_exploded/subcheckin?classid=<%=classinfo.get(0)%>&stuid=<%=userBean.getLogid()%>&checkin_id=<%=scheckIn.getCheckin_id()%>">
                            <button class="logout-button">签到</button>
                        </a>
                        </td>
                    </tr>
                    <% } %>
